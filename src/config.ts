...
export const MAILER_TRANSPORT_HOST = (process.env.MAILER_TRANSPORT_HOST || "smtp.ethereal.email") as string;
...
export const MAILER_EMAIL = (process.env.MAILER_EMAIL || "davon.maggio@ethereal.email") as string;
export const MAILER_PASSWORD = (process.env.MAILER_PASSWORD || "g4W7dN5awJcpXRnGX5") as string;
